...
4. 第二个 Servlet 处理完数据后将最终处理结果返回给客户端。
   ...
   具体过程如图所示：![3dbb4bd01fc49cf7a9d24b7b2d5ecd88](.\img\3dbb4bd01fc49cf7a9d24b7b2d5ecd88.png)
...
1. 重定向的工作流程如下：
   ...
   4. 客户端收到响应结果后，从 HTTP 响应头中取得相关信息，再次发送请求数据给服务器。
      ...
      具体过程如图所示：![1c2e74b05b01cca65422201a6fbe581f](.\img\1c2e74b05b01cca65422201a6fbe581f.png)
...
- Servlet的生命分为以下四部分：Servlet实例化 --> 初始化 --> 服务 --> 销毁
  ...
  4. 销毁：对应 destroy 方法。destroy() 方法仅执行一次，只在 Web 服务器端停止并卸载 Servlet 时执行。当 Servlet 对象被销毁时，并释放其占用的资源。
     ...
     ![1921685404126151e6bafc42faa0cfb5](.\img\1921685404126151e6bafc42faa0cfb5.png)
...
- Servlet 生命周期的各个阶段
  ...
  ![ba82a313afcdfeb0bee5557b64f62a43](.\img\ba82a313afcdfeb0bee5557b64f62a43.png)
