...
![二分查找示例数据](http://minio.ozh.asia/blog/二分查找示例数据.png)
...
![二分查找流程](http://minio.ozh.asia/blog/二分查找流程1.png)

@tab Step2

![二分查找流程](http://minio.ozh.asia/blog/二分查找流程2.png)

@tab Step3

![二分查找流程](http://minio.ozh.asia/blog/二分查找流程3.png)

@tab Step4

![二分查找流程](http://minio.ozh.asia/blog/二分查找流程4.png)

@tab Step5

![二分查找流程](http://minio.ozh.asia/blog/二分查找流程5.png)

@tab Step6

![二分查找流程](http://minio.ozh.asia/blog/二分查找流程6.png)

@tab Step7

![二分查找流程](http://minio.ozh.asia/blog/二分查找流程7.png)
...
![两种区间定义](http://minio.ozh.asia/blog/两种区间定义.png)
...
![二分查找插入点示例数据](http://minio.ozh.asia/blog/二分查找插入点示例数据.png)
...
![线性查找重复元素的插入点](http://minio.ozh.asia/blog/线性查找重复元素的插入点.png)
...
![二分查找重复元素的插入点的步骤](http://minio.ozh.asia/blog/二分查找重复元素的插入点的步骤1.png)

@tab Step2

![二分查找重复元素的插入点的步骤](http://minio.ozh.asia/blog/二分查找重复元素的插入点的步骤2.png)

@tab Step3

![二分查找重复元素的插入点的步骤](http://minio.ozh.asia/blog/二分查找重复元素的插入点的步骤3.png)

@tab Step4

![二分查找重复元素的插入点的步骤](http://minio.ozh.asia/blog/二分查找重复元素的插入点的步骤4.png)

@tab Step5

![二分查找重复元素的插入点的步骤](http://minio.ozh.asia/blog/二分查找重复元素的插入点的步骤5.png)

@tab Step6

![二分查找重复元素的插入点的步骤](http://minio.ozh.asia/blog/二分查找重复元素的插入点的步骤6.png)

@tab Step7

![二分查找重复元素的插入点的步骤](http://minio.ozh.asia/blog/二分查找重复元素的插入点的步骤7.png)

@tab Step8

![二分查找重复元素的插入点的步骤](http://minio.ozh.asia/blog/二分查找重复元素的插入点的步骤8.png)
...
![将查找右边界转化为查找左边界](http://minio.ozh.asia/blog/将查找右边界转化为查找左边界.png)
...
![将查找边界转化为查找元素](http://minio.ozh.asia/blog/将查找边界转化为查找元素.png)
...
![线性查找求解两数之和](http://minio.ozh.asia/blog/线性查找求解两数之和.png)
...
![辅助哈希表求解两数之和](http://minio.ozh.asia/blog/辅助哈希表求解两数之和1.png)

@tab Step2

![辅助哈希表求解两数之和](http://minio.ozh.asia/blog/辅助哈希表求解两数之和2.png)

@tab Step3

![辅助哈希表求解两数之和](http://minio.ozh.asia/blog/辅助哈希表求解两数之和3.png)
...
![多种搜索策略](http://minio.ozh.asia/blog/多种搜索策略.png)
