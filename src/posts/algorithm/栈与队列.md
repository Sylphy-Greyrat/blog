...
![基于链表实现栈的入栈出栈操作](./img/基于链表实现栈的入栈出栈操作1.png)

@tab push()

![基于链表实现栈的入栈出栈操作](./img/基于链表实现栈的入栈出栈操作2.png)

@tab pop()

![基于链表实现栈的入栈出栈操作](./img/基于链表实现栈的入栈出栈操作3.png)
...
![基于数组实现栈的入栈出栈操作](./img/基于数组实现栈的入栈出栈操作1.png)

@tab push()

![基于数组实现栈的入栈出栈操作](./img/基于数组实现栈的入栈出栈操作2.png)

@tab pop()

![基于数组实现栈的入栈出栈操作](./img/基于数组实现栈的入栈出栈操作3.png)
...
![基于链表实现队列的入队出队操作](./img/基于链表实现队列的入队出队操作1.png)

@tab push()

![基于链表实现队列的入队出队操作](./img/基于链表实现队列的入队出队操作2.png)

@tab pop()

![基于链表实现队列的入队出队操作](./img/基于链表实现队列的入队出队操作3.png)
...
![基于数组实现队列的入队出队操作](./img/基于数组实现队列的入队出队操作1.png)

@tab push()

![基于数组实现队列的入队出队操作](./img/基于数组实现队列的入队出队操作2.png)

@tab pop()

![基于数组实现队列的入队出队操作](./img/基于数组实现队列的入队出队操作3.png)
...
![基于链表实现双向队列的入队出队操作](./img/基于链表实现双向队列的入队出队操作1.png)

@tab push_last()

![基于链表实现双向队列的入队出队操作](./img/基于链表实现双向队列的入队出队操作2.png)

@tab push_first()

![基于链表实现双向队列的入队出队操作](./img/基于链表实现双向队列的入队出队操作3.png)

@tab pop_last()

![基于链表实现双向队列的入队出队操作](./img/基于链表实现双向队列的入队出队操作4.png)

@tab pop_first()

![基于链表实现双向队列的入队出队操作](./img/基于链表实现双向队列的入队出队操作5.png)
...
![基于数组实现双向队列的入队出队操作](./img/基于数组实现双向队列的入队出队操作1.png)

@tab push_last()

![基于数组实现双向队列的入队出队操作](./img/基于数组实现双向队列的入队出队操作2.png)

@tab push_first()

![基于数组实现双向队列的入队出队操作](./img/基于数组实现双向队列的入队出队操作3.png)

@tab pop_last()

![基于数组实现双向队列的入队出队操作](./img/基于数组实现双向队列的入队出队操作4.png)

@tab pop_first()

![基于数组实现双向队列的入队出队操作](./img/基于数组实现双向队列的入队出队操作5.png)
