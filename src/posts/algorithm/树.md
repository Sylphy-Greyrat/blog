...
![父节点、子节点、子树](http://101.43.49.28:9000/blog/父节点、子节点、子树.png)
...
![二叉树的常用术语](http://101.43.49.28:9000/blog/二叉树的常用术语.png)
...
![在二叉树中插入与删除节点](http://101.43.49.28:9000/blog/在二叉树中插入与删除节点.png)
...
![完美二叉树](http://101.43.49.28:9000/blog/完美二叉树.png)

#### 完全二叉树

​	如下图所示，「完全二叉树 complete binary tree」只有最底层的节点未被填满，且最底层节点尽量靠左填充。

![完全二叉树](http://101.43.49.28:9000/blog/完全二叉树.png)

#### 完满二叉树

​	如下图所示，「完满二叉树 full binary tree」除了叶节点之外，其余所有节点都有两个子节点。

![完满二叉树](http://101.43.49.28:9000/blog/完满二叉树.png)

#### 平衡二叉树

​	如下图所示，「平衡二叉树 balanced binary tree」中任意节点的左子树和右子树的高度之差的绝对值不超过 1 。

![平衡二叉树](http://101.43.49.28:9000/blog/平衡二叉树.png)
...
![二叉树的最佳结构与最差结构](http://101.43.49.28:9000/blog/二叉树的最佳结构与最差结构.png)
...
![二叉树的层序遍历](http://101.43.49.28:9000/blog/二叉树的层序遍历.png)
...
![二叉搜索树的前序、中序、后序遍历](http://101.43.49.28:9000/blog/二叉搜索树的前序、中序、后序遍历.png)
...
![前序遍历的递归过程](http://101.43.49.28:9000/blog/前序遍历的递归过程1.png)

@tab Step2

![前序遍历的递归过程](http://101.43.49.28:9000/blog/前序遍历的递归过程2.png)

@tab Step3

![前序遍历的递归过程](http://101.43.49.28:9000/blog/前序遍历的递归过程3.png)

@tab Step4

![前序遍历的递归过程](http://101.43.49.28:9000/blog/前序遍历的递归过程4.png)

@tab Step5

![前序遍历的递归过程](http://101.43.49.28:9000/blog/前序遍历的递归过程5.png)

@tab Step6

![前序遍历的递归过程](http://101.43.49.28:9000/blog/前序遍历的递归过程6.png)

@tab Step7

![前序遍历的递归过程](http://101.43.49.28:9000/blog/前序遍历的递归过程7.png)

@tab Step8

![前序遍历的递归过程](http://101.43.49.28:9000/blog/前序遍历的递归过程8.png)

@tab Step9

![前序遍历的递归过程](http://101.43.49.28:9000/blog/前序遍历的递归过程9.png)

@tab Step10

![前序遍历的递归过程](http://101.43.49.28:9000/blog/前序遍历的递归过程10.png)

@tab Step11

![前序遍历的递归过程](http://101.43.49.28:9000/blog/前序遍历的递归过程11.png)
...
![完美二叉树的数组表示](http://101.43.49.28:9000/blog/完美二叉树的数组表示.png)
...
![层序遍历序列对应多种二叉树可能性](http://101.43.49.28:9000/blog/层序遍历序列对应多种二叉树可能性.png)
...
![任意类型二叉树的数组表示](http://101.43.49.28:9000/blog/任意类型二叉树的数组表示.png)

​	值得说明的是，**完全二叉树非常适合使用数组来表示**。回顾完全二叉树的定义，None 只出现在最底层且靠右的位置，**因此所有 None 一定出现在层序遍历序列的末尾**。

​	这意味着使用数组表示完全二叉树时，可以省略存储所有 None，非常方便，下图给出了一个例子。

![完全二叉树的数组表示](http://101.43.49.28:9000/blog/完全二叉树的数组表示.png)
...
![二叉搜索树](http://101.43.49.28:9000/blog/二叉搜索树.png)
...
![二叉搜索树查找节点示例](http://101.43.49.28:9000/blog/二叉搜索树查找节点示例1.png)

@tab Step2

![二叉搜索树查找节点示例](http://101.43.49.28:9000/blog/二叉搜索树查找节点示例2.png)

@tab Step3

![二叉搜索树查找节点示例](http://101.43.49.28:9000/blog/二叉搜索树查找节点示例3.png)

@tab Step4

![二叉搜索树查找节点示例](http://101.43.49.28:9000/blog/二叉搜索树查找节点示例4.png)
...
![在二叉搜索树中插入节点](http://101.43.49.28:9000/blog/在二叉搜索树中插入节点.png)
...
![在二叉搜索树中删除节点（度为 0 ）](http://101.43.49.28:9000/blog/在二叉搜索树中删除节点（度为0）.png)

如下图所示，当待删除节点替换为其字节点即可。

![在二叉搜索树中删除节点（度为 1 ）](http://101.43.49.28:9000/blog/在二叉搜索树中删除节点（度为1）.png)
...
![在二叉搜索树中删除节点（度为 2 ）](http://101.43.49.28:9000/blog/在二叉搜索树中删除节点（度为2）1.png)

@tab Step2

![在二叉搜索树中删除节点（度为 2 ）](http://101.43.49.28:9000/blog/在二叉搜索树中删除节点（度为2）2.png)

@tab Step3

![在二叉搜索树中删除节点（度为 2 ）](http://101.43.49.28:9000/blog/在二叉搜索树中删除节点（度为2）3.png)

@tab Step4

![在二叉搜索树中删除节点（度为 2 ）](http://101.43.49.28:9000/blog/在二叉搜索树中删除节点（度为2）4.png)
...
![二叉搜索树的中序遍历序列](http://101.43.49.28:9000/blog/二叉搜索树的中序遍历序列.png)
...
![二叉搜索树退化](http://101.43.49.28:9000/blog/二叉搜索树退化.png)
...
![AVL 树在删除节点后发生退化](http://101.43.49.28:9000/blog/AVL树在删除节点后发生退化.png)

​	再例如，在下图所示的完美二叉树中插入两个节点后，树将严重向左倾斜，查找操作的时间复杂度也随之劣化。

![AVL 树在插入节点后发生退化](http://101.43.49.28:9000/blog/AVL树在插入节点后发生退化.png)
...
![右旋操作步骤](http://101.43.49.28:9000/blog/右旋操作步骤1.png)

@tab Step2

![右旋操作步骤](http://101.43.49.28:9000/blog/右旋操作步骤2.png)

@tab Step3

![右旋操作步骤](http://101.43.49.28:9000/blog/右旋操作步骤3.png)

@tab Step4

![右旋操作步骤](http://101.43.49.28:9000/blog/右旋操作步骤4.png)

:::

​	如下图所示，当节点 child 有右子节点（记为 grand_child）时，需要在右旋中添加一步：将 grand_child 作为 node 的左子节点。

![有 grand_child 的右旋操作](http://101.43.49.28:9000/blog/有grand_child的右旋操作.png)
...
![左旋操作](http://101.43.49.28:9000/blog/左旋操作.png)

​	同理，如下图所示，当节点 child 有左子节点（记为 grand_child）时，需要在左旋中添加一步：将 grand_child 作为 node 的右子节点。

![有 grand_child 的左旋操作](http://101.43.49.28:9000/blog/有grand_child的左旋操作.png)
...
![先左旋后右旋](http://101.43.49.28:9000/blog/先左旋后右旋.png)

#### 先右旋后左旋

​	如下图所示，对于上述失衡二叉树的镜像情况，需要先对 child 执行“右旋”，再对 node 执行“左旋”。

![先右旋后左旋](http://101.43.49.28:9000/blog/先右旋后左旋.png)

#### 旋转的选择

​	下图展示的四种失衡情况与上述案例逐个对应，分别需要采用右旋、先左旋后右旋、先右旋后左旋、左旋的操作。

![AVL 树的四种旋转情况](http://101.43.49.28:9000/blog/AVL树的四种旋转情况.png)
