...
![小顶堆与大顶堆](http://minio.ozh.asia/blog/小顶堆与大顶堆.png)
...
![堆的表示与存储](http://minio.ozh.asia/blog/堆的表示与存储.png)
...
![元素入堆步骤](http://minio.ozh.asia/blog/元素入堆步骤1.png)

@Step2

![元素入堆步骤](http://minio.ozh.asia/blog/元素入堆步骤2.png)

@Step3

![元素入堆步骤](http://minio.ozh.asia/blog/元素入堆步骤3.png)

@Step4

![元素入堆步骤](http://minio.ozh.asia/blog/元素入堆步骤4.png)

@Step5

![元素入堆步骤](http://minio.ozh.asia/blog/元素入堆步骤5.png)@Step6

![元素入堆步骤](http://minio.ozh.asia/blog/元素入堆步骤6.png)

@Step7

![元素入堆步骤](http://minio.ozh.asia/blog/元素入堆步骤7.png)

@Step8

![元素入堆步骤](http://minio.ozh.asia/blog/元素入堆步骤8.png)

@Step9

![元素入堆步骤](http://minio.ozh.asia/blog/元素入堆步骤9.png)
...
![堆顶元素出堆步骤](http://minio.ozh.asia/blog/堆顶元素出堆步骤1.png)

@tab Step2

![堆顶元素出堆步骤](http://minio.ozh.asia/blog/堆顶元素出堆步骤2.png)

@tab Step3

![堆顶元素出堆步骤](http://minio.ozh.asia/blog/堆顶元素出堆步骤3.png)

@tab Step4

![堆顶元素出堆步骤](http://minio.ozh.asia/blog/堆顶元素出堆步骤4.png)

@tab Step5

![堆顶元素出堆步骤](http://minio.ozh.asia/blog/堆顶元素出堆步骤5.png)

@tab Step6

![堆顶元素出堆步骤](http://minio.ozh.asia/blog/堆顶元素出堆步骤6.png)

@tab Step7

![堆顶元素出堆步骤](http://minio.ozh.asia/blog/堆顶元素出堆步骤7.png)

@tab Step8

![堆顶元素出堆步骤](http://minio.ozh.asia/blog/堆顶元素出堆步骤8.png)

@tab Step9

![堆顶元素出堆步骤](http://minio.ozh.asia/blog/堆顶元素出堆步骤9.png)

@tab Step10

![堆顶元素出堆步骤](http://minio.ozh.asia/blog/堆顶元素出堆步骤10.png)
...
![完美二叉树的各层节点数量](http://minio.ozh.asia/blog/完美二叉树的各层节点数量.png)
...
![遍历寻找最大的 k 个元素](http://minio.ozh.asia/blog/遍历寻找最大的k个元素.png)
...
![排序寻找最大的 k 个元素](http://minio.ozh.asia/blog/排序寻找最大的k个元素.png)
...
![基于堆寻找最大的 k 个元素](http://minio.ozh.asia/blog/基于堆寻找最大的k个元素1.png)

@tab Step2

![基于堆寻找最大的 k 个元素](http://minio.ozh.asia/blog/基于堆寻找最大的k个元素2.png)

@tab Step3

![基于堆寻找最大的 k 个元素](http://minio.ozh.asia/blog/基于堆寻找最大的k个元素3.png)

@tab Step4

![基于堆寻找最大的 k 个元素](http://minio.ozh.asia/blog/基于堆寻找最大的k个元素4.png)

@tab Step5

![基于堆寻找最大的 k 个元素](http://minio.ozh.asia/blog/基于堆寻找最大的k个元素5.png)

@tab Step6

![基于堆寻找最大的 k 个元素](http://minio.ozh.asia/blog/基于堆寻找最大的k个元素6.png)

@tab Step7

![基于堆寻找最大的 k 个元素](http://minio.ozh.asia/blog/基于堆寻找最大的k个元素7.png)

@tab Step8

![基于堆寻找最大的 k 个元素](http://minio.ozh.asia/blog/基于堆寻找最大的k个元素8.png)

@tab Step9

![基于堆寻找最大的 k 个元素](http://minio.ozh.asia/blog/基于堆寻找最大的k个元素9.png)
