...
![数据类型和判断规则示例](http://minio.sylphy.me/blog/数据类型和判断规则示例.png)
...
![选择排序步骤](http://minio.sylphy.me/blog/选择排序步骤1.png)

@tab Step2

![选择排序步骤](http://minio.sylphy.me/blog/选择排序步骤2.png)

@tab Step3

![选择排序步骤](http://minio.sylphy.me/blog/选择排序步骤3.png)

@tab Step4

![选择排序步骤](http://minio.sylphy.me/blog/选择排序步骤4.png)

@tab Step5

![选择排序步骤](http://minio.sylphy.me/blog/选择排序步骤5.png)

@tab Step6

![选择排序步骤](http://minio.sylphy.me/blog/选择排序步骤6.png)

@tab Step7

![选择排序步骤](http://minio.sylphy.me/blog/选择排序步骤7.png)

@tab Step8

![选择排序步骤](http://minio.sylphy.me/blog/选择排序步骤8.png)
...
![选择排序步骤](http://minio.sylphy.me/blog/选择排序步骤9.png)

@tab Step10

![选择排序步骤](http://minio.sylphy.me/blog/选择排序步骤10.png)

@tab Step11

![选择排序步骤](http://minio.sylphy.me/blog/选择排序步骤11.png)
...
- **非稳定排序**：如下图所示，元素 nums[i] 有可能被交换至与其相等的元素的右边，导致两者的相对顺序发生改变。
  ...
  ![选择排序非稳定示例](http://minio.sylphy.me/blog/选择排序非稳定示例.png)
...
![利用元素交换操作模拟冒泡](http://minio.sylphy.me/blog/利用元素交换操作模拟冒泡1.png)

@tab Step2

![利用元素交换操作模拟冒泡](http://minio.sylphy.me/blog/利用元素交换操作模拟冒泡2.png)

@tab Step3

![利用元素交换操作模拟冒泡](http://minio.sylphy.me/blog/利用元素交换操作模拟冒泡3.png)

@tab Step4

![利用元素交换操作模拟冒泡](http://minio.sylphy.me/blog/利用元素交换操作模拟冒泡4.png)

@tab Step5

![利用元素交换操作模拟冒泡](http://minio.sylphy.me/blog/利用元素交换操作模拟冒泡5.png)

@tab Step6

![利用元素交换操作模拟冒泡](http://minio.sylphy.me/blog/利用元素交换操作模拟冒泡6.png)

@tab Step7

![利用元素交换操作模拟冒泡](http://minio.sylphy.me/blog/利用元素交换操作模拟冒泡7.png)
...
![冒泡排序流程](http://minio.sylphy.me/blog/冒泡排序流程.png)
...
![单次插入操作](http://minio.sylphy.me/blog/单次插入操作.png)
...
![插入排序流程](http://minio.sylphy.me/blog/插入排序流程.png)
...
![哨兵划分步骤](http://minio.sylphy.me/blog/哨兵划分步骤1.png)

@tab Step2

![哨兵划分步骤](http://minio.sylphy.me/blog/哨兵划分步骤2.png)

@tab Step3

![哨兵划分步骤](http://minio.sylphy.me/blog/哨兵划分步骤3.png)

@tab Step4

![哨兵划分步骤](http://minio.sylphy.me/blog/哨兵划分步骤4.png)

@tab Step5

![哨兵划分步骤](http://minio.sylphy.me/blog/哨兵划分步骤5.png)

@tab Step6

![哨兵划分步骤](http://minio.sylphy.me/blog/哨兵划分步骤6.png)

@tab Step7

![哨兵划分步骤](http://minio.sylphy.me/blog/哨兵划分步骤7.png)

@tab Step8

![哨兵划分步骤](http://minio.sylphy.me/blog/哨兵划分步骤8.png)

@tab Step9

![哨兵划分步骤](http://minio.sylphy.me/blog/哨兵划分步骤9.png)
...
![快速排序流程](http://minio.sylphy.me/blog/快速排序流程.png)
...
![归并排序的划分与合并阶段](http://minio.sylphy.me/blog/归并排序的划分与合并阶段.png)
...
![归并排序步骤](http://minio.sylphy.me/blog/归并排序步骤1.png)

@tab Step2

![归并排序步骤](http://minio.sylphy.me/blog/归并排序步骤2.png)

@tab Step3

![归并排序步骤](http://minio.sylphy.me/blog/归并排序步骤3.png)

@tab Step4

![归并排序步骤](http://minio.sylphy.me/blog/归并排序步骤4.png)

@tab Step5

![归并排序步骤](http://minio.sylphy.me/blog/归并排序步骤5.png)

@tab Step6

![归并排序步骤](http://minio.sylphy.me/blog/归并排序步骤6.png)

@tab Step7

![归并排序步骤](http://minio.sylphy.me/blog/归并排序步骤7.png)

@tab Step8

![归并排序步骤](http://minio.sylphy.me/blog/归并排序步骤8.png)

@tab Step9

![归并排序步骤](http://minio.sylphy.me/blog/归并排序步骤9.png)

@tab Step10

![归并排序步骤](http://minio.sylphy.me/blog/归并排序步骤10.png)
...
![堆排序步骤](http://minio.sylphy.me/blog/堆排序步骤1.png)

@tab Step2

![堆排序步骤](http://minio.sylphy.me/blog/堆排序步骤2.png)

@tab Step3

![堆排序步骤](http://minio.sylphy.me/blog/堆排序步骤3.png)

@tab Step4

![堆排序步骤](http://minio.sylphy.me/blog/堆排序步骤4.png)

@tab Step5

![堆排序步骤](http://minio.sylphy.me/blog/堆排序步骤5.png)

@tab Step6

![堆排序步骤](http://minio.sylphy.me/blog/堆排序步骤6.png)

@tab Step7

![堆排序步骤](http://minio.sylphy.me/blog/堆排序步骤7.png)

@tab Step8

![堆排序步骤](http://minio.sylphy.me/blog/堆排序步骤8.png)

@tab Step9

![堆排序步骤](http://minio.sylphy.me/blog/堆排序步骤9.png)

@tab Step10

![堆排序步骤](http://minio.sylphy.me/blog/堆排序步骤10.png)

@tab Step11

![堆排序步骤](http://minio.sylphy.me/blog/堆排序步骤11.png)

@tab Step12

![堆排序步骤](http://minio.sylphy.me/blog/堆排序步骤12.png)
...
![桶排序算法流程](http://minio.sylphy.me/blog/桶排序算法流程.png)
...
![递归划分桶](http://minio.sylphy.me/blog/递归划分桶.png)

​	如果我们提前知道商品价格的概率分布，**则可以根据数据概率分布设置每个桶的价格分界线**。值得注意的是，数据分布并不一定需要特意统计，也可以根据数据特点采用某种概率模型进行近似。

​	如下图所示，假设商品价格服从正态分布，这样就可以合理地设定价格区间，从而将商品平均分配到各个桶中。

![根据概率分布划分桶](http://minio.sylphy.me/blog/根据概率分布划分桶.png)
...
![计数排序流程](http://minio.sylphy.me/blog/计数排序流程.png)
...
![计数排序步骤](http://minio.sylphy.me/blog/计数排序步骤1.png)

@tab Step2

![计数排序步骤](http://minio.sylphy.me/blog/计数排序步骤2.png)

@tab Step3

![计数排序步骤](http://minio.sylphy.me/blog/计数排序步骤3.png)
@tab Step4

![计数排序步骤](http://minio.sylphy.me/blog/计数排序步骤4.png)
@tab Step5

![计数排序步骤](http://minio.sylphy.me/blog/计数排序步骤5.png)
@tab Step6

![计数排序步骤](http://minio.sylphy.me/blog/计数排序步骤6.png)
@tab Step7

![计数排序步骤](http://minio.sylphy.me/blog/计数排序步骤7.png)
@tab Step8

![计数排序步骤](http://minio.sylphy.me/blog/计数排序步骤8.png)
...
![基数排序算法流程](http://minio.sylphy.me/blog/基数排序算法流程.png)
