...
![数据类型和判断规则示例](./img/数据类型和判断规则示例.png)
...
![选择排序步骤](./img/选择排序步骤1.png)

@tab Step2

![选择排序步骤](./img/选择排序步骤2.png)

@tab Step3

![选择排序步骤](./img/选择排序步骤3.png)

@tab Step4

![选择排序步骤](./img/选择排序步骤4.png)

@tab Step5

![选择排序步骤](./img/选择排序步骤5.png)

@tab Step6

![选择排序步骤](./img/选择排序步骤6.png)

@tab Step7

![选择排序步骤](./img/选择排序步骤7.png)

@tab Step8

![选择排序步骤](./img/选择排序步骤8.png)
...
![选择排序步骤](./img/选择排序步骤9.png)

@tab Step10

![选择排序步骤](./img/选择排序步骤10.png)

@tab Step11

![选择排序步骤](./img/选择排序步骤11.png)
...
![利用元素交换操作模拟冒泡](./img/利用元素交换操作模拟冒泡1.png)

@tab Step2

![利用元素交换操作模拟冒泡](./img/利用元素交换操作模拟冒泡2.png)

@tab Step3

![利用元素交换操作模拟冒泡](./img/利用元素交换操作模拟冒泡3.png)

@tab Step4

![利用元素交换操作模拟冒泡](./img/利用元素交换操作模拟冒泡4.png)

@tab Step5

![利用元素交换操作模拟冒泡](./img/利用元素交换操作模拟冒泡5.png)

@tab Step6

![利用元素交换操作模拟冒泡](./img/利用元素交换操作模拟冒泡6.png)

@tab Step7

![利用元素交换操作模拟冒泡](./img/利用元素交换操作模拟冒泡7.png)
...
![哨兵划分步骤](./img/哨兵划分步骤1.png)

@tab Step2

![哨兵划分步骤](./img/哨兵划分步骤2.png)

@tab Step3

![哨兵划分步骤](./img/哨兵划分步骤3.png)

@tab Step4

![哨兵划分步骤](./img/哨兵划分步骤4.png)

@tab Step5

![哨兵划分步骤](./img/哨兵划分步骤5.png)

@tab Step6

![哨兵划分步骤](./img/哨兵划分步骤6.png)

@tab Step7

![哨兵划分步骤](./img/哨兵划分步骤7.png)

@tab Step8

![哨兵划分步骤](./img/哨兵划分步骤8.png)

@tab Step9

![哨兵划分步骤](./img/哨兵划分步骤9.png)
...
![归并排序的划分与合并阶段](./img/归并排序的划分与合并阶段.png)
...
![归并排序步骤](./img/归并排序步骤1.png)

@tab Step2

![归并排序步骤](./img/归并排序步骤2.png)

@tab Step3

![归并排序步骤](./img/归并排序步骤3.png)

@tab Step4

![归并排序步骤](./img/归并排序步骤4.png)

@tab Step5

![归并排序步骤](./img/归并排序步骤5.png)

@tab Step6

![归并排序步骤](./img/归并排序步骤6.png)

@tab Step7

![归并排序步骤](./img/归并排序步骤7.png)

@tab Step8

![归并排序步骤](./img/归并排序步骤8.png)

@tab Step9

![归并排序步骤](./img/归并排序步骤9.png)

@tab Step10

![归并排序步骤](./img/归并排序步骤10.png)
...
![堆排序步骤](./img/堆排序步骤1.png)

@tab Step2

![堆排序步骤](./img/堆排序步骤2.png)

@tab Step3

![堆排序步骤](./img/堆排序步骤3.png)

@tab Step4

![堆排序步骤](./img/堆排序步骤4.png)

@tab Step5

![堆排序步骤](./img/堆排序步骤5.png)

@tab Step6

![堆排序步骤](./img/堆排序步骤6.png)

@tab Step7

![堆排序步骤](./img/堆排序步骤7.png)

@tab Step8

![堆排序步骤](./img/堆排序步骤8.png)

@tab Step9

![堆排序步骤](./img/堆排序步骤9.png)

@tab Step10

![堆排序步骤](./img/堆排序步骤10.png)

@tab Step11

![堆排序步骤](./img/堆排序步骤11.png)

@tab Step12

![堆排序步骤](./img/堆排序步骤12.png)
...
![计数排序步骤](./img/计数排序步骤1.png)

@tab Step2

![计数排序步骤](./img/计数排序步骤2.png)

@tab Step3

![计数排序步骤](./img/计数排序步骤3.png)
@tab Step4

![计数排序步骤](./img/计数排序步骤4.png)
@tab Step5

![计数排序步骤](./img/计数排序步骤5.png)
@tab Step6

![计数排序步骤](./img/计数排序步骤6.png)
@tab Step7

![计数排序步骤](./img/计数排序步骤7.png)
@tab Step8

![计数排序步骤](./img/计数排序步骤8.png)
