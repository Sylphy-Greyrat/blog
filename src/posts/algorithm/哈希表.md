...
![哈希表的抽象表示](http://minio.ozh.asia/blog/哈希表的抽象表示.png)
...
![哈希函数工作原理](http://minio.ozh.asia/blog/哈希函数工作原理.png)
...
![哈希冲突示例](http://minio.ozh.asia/blog/哈希冲突示例.png)

​	容易想到，哈希表容量 n 越大，多个 key 被分配到同一个桶中的概率就越低，冲突就越少。因此，**我们可以通过扩容哈希表来减少哈希冲突**。

如下图所示，扩容前键值对 (136,A) 和 (236,D) 发生冲突，扩容后冲突消失。

![哈希表扩容](http://minio.ozh.asia/blog/哈希表扩容.png)
...
![链式地址哈希表](http://minio.ozh.asia/blog/链式地址哈希表.png)
...
![开放寻址（线性探测）哈希表的键值对分布](http://minio.ozh.asia/blog/开放寻址（线性探测）哈希表的键值对分布.png)
...
![在开放寻址中删除元素导致的查询问题](http://minio.ozh.asia/blog/在开放寻址中删除元素导致的查询问题.png)
...
![哈希冲突的最佳情况与最差情况](http://minio.ozh.asia/blog/哈希冲突的最佳情况与最差情况.png)
