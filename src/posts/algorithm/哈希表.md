...
![开放寻址（线性探测）哈希表的键值对分布](./img/开放寻址（线性探测）哈希表的键值对分布.png)
...
![在开放寻址中删除元素导致的查询问题](./img/在开放寻址中删除元素导致的查询问题.png)
...
![哈希冲突的最佳情况与最差情况](./img/哈希冲突的最佳情况与最差情况.png)
