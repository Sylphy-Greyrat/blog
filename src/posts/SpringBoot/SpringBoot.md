...
2. JSP页面组成
   ...
   ![JSP 页面组成](http://minio.ozh.asia/blog/JSP页面组成.png)
...
4. Form 表单的请求处理
   ...
   - JSP 根据处理结果，转向不同的结果页面
     ...
     ![Form 表单的处理过程](http://minio.ozh.asia/blog/Form表单的处理过程.png)
...
2. 设置
   ...
   ![单元测试设置-1](http://minio.ozh.asia/blog/单元测试设置-1.png)

   ![单元测试设置-2](http://minio.ozh.asia/blog/单元测试设置-2.png)
...
2. 初始化Spring Boot项目启动：
   ...
   6. 持续运行上下文：使监听器持续运行配置好的应用上下文
      ...
      ![Spring Boot项目启动流程](http://minio.ozh.asia/blog/SpringBoot项目启动流程.png)
