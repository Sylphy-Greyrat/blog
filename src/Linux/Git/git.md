...
7. 简图
   ...
   ![指针的变化](http://www.ozh.asia:9000/blog/指针的变化.png)
...
![指针和节点](http://www.ozh.asia:9000/blog/指针和节点.png)
...
![创建了新分支](http://www.ozh.asia:9000/blog/创建了新分支.png)

- 此时，我们创建了一个新的分支 dev，HEAD 指向 dev，意思就是我们当前处于 dev 分支

![dev 分支提交新节点](http://www.ozh.asia:9000/blog/dev分支提交新节点.png)

- 此时，在 dev 分支做了提交，dev 分支向前移动一步，master 分支不变

![将 dev 合并到 master](http://www.ozh.asia:9000/blog/将dev合并到master.png)

- 此时，我们将 dev 分支合并到 master 分支上，并且切换回 master 分支

![删除 dev 分支](http://www.ozh.asia:9000/blog/删除dev分支.png)
...
![idea操作方法](http://www.ozh.asia:9000/blog/idea操作方法.png)

随后，idea 会提示我们无法自动合并，下面就是冲突文件的展示，我们在这里简单选择处理冲突即可

![冲突选择](http://www.ozh.asia:9000/blog/冲突选择.png)
...
![代码演示1](http://www.ozh.asia:9000/blog/代码演示1.png)

但与此同时，我正在 dev 上开发代码

![代码演示2](http://www.ozh.asia:9000/blog/代码演示2.png)

​	这个时候，在 dev 上开发的代码还未完成，我还不想提交，但是切换分支又需要将代码转移到其他分支，这个时候可以使用 **git stash** 命令，idea 的可视化面板操作相对应下图

<img alt="idea的git stash操作" src="http://www.ozh.asia:9000/blog/idea的git stash操作1.png"/>

<img alt="idea的git stash操作2" src="http://www.ozh.asia:9000/blog/idea的git stash操作2.png"/>

这样就可以将代码展示保存起来，那我们就可以切换到 master 分支之后新建一个 bug 分支来解决 bug

<img alt="idea的git stash操作3" src="http://www.ozh.asia:9000/blog/idea的git stash操作3.png"/>
...
<img alt="idea的git stash操作4" src="http://www.ozh.asia:9000/blog/idea的git stash操作4.png"/>

这样，我们在 dev 分支上的 bug 也得到修复了，随后我们再选择 unstash（取消隐藏更改），来恢复我们刚刚的代码

<img alt="idea的git stash操作5" src="http://www.ozh.asia:9000/blog/idea的git stash操作5.png"/>
...
<img alt="未执行git rebase时" src="http://www.ozh.asia:9000/blog/未执行git rebase时.png"/>

<img alt="执行git rebase后" src="http://www.ozh.asia:9000/blog/执行git rebase后.png"/>

![变基前后的分支对比](http://www.ozh.asia:9000/blog/变基前后的分支对比.png)
